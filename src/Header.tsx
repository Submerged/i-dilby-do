...
export const Header = () => {
    return (
        <Box p={4}>
            <Box textAlign='center' fontFamily={`'Sacramento', sans-serif`} fontSize={82} bgGradient='radial(custom.8, custom.8, custom.8, custom.8, custom.3, custom.3, custom.3)' color='custom.4'>Charlotte & Dylan</Box>
